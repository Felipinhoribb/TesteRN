...
public class Import {
	...
	//Realiza a leitura dos dados e Salva no Banco de dados
	public void importarPlanilha(InputStream arquivo) throws Exception {
		
		/*
		 * Implementação da leitura do arquivo
		 * Criação de workbook para manipular arquivo xlsx e recuperação da primeira aba da planilha
		 */
		...
		while (rowIterator.hasNext()) {
			...
			while (cellIterator.hasNext()) {
				...
				//Recupera os valores das células da planilha no objCli
